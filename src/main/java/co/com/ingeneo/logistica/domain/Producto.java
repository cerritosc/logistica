...
public class Producto implements Serializable {
    ...
    @Column(name = "sk_producto")
    @EqualsAndHashCode.Include
    @JsonView
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "logistica.SEQ_producto")
    @SequenceGenerator(name = "logistica.SEQ_producto", sequenceName = "logistica.SEQ_producto", allocationSize = 1)
    private Integer skProducto; 
