...
@Table(name = "bodega", schema="logistica")
public class Bodega implements Serializable {
    ...
    @Column(name = "sk_bodega")
    @EqualsAndHashCode.Include
    @JsonView
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "logistica.SEQ_bodega")
    @SequenceGenerator(name = "logistica.SEQ_bodega", sequenceName = "logistica.SEQ_bodega", allocationSize = 1)
